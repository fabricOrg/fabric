...
/** Staff-side invite into a specific tenant. Sends a WorkOS org invitation + creates the membership. */
export function InviteTenantMemberDialog({ tenantId }: { tenantId: string }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        >
          <DialogHeader>
            <DialogTitle>Invite a member to this tenant</DialogTitle>
            <DialogDescription>
              They&apos;ll get an email to join this organisation on Fabric.
            </DialogDescription>
          </DialogHeader>
